...
public class Fmthings extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Members {
    ...
    public class Search extends FmthingsRequest<com.google.api.services.fmthings.model.CollectionResponseAppMember> {
      ...
      protected Search(java.lang.String email) {
        super(Fmthings.this, "POST", REST_PATH, null, com.google.api.services.fmthings.model.CollectionResponseAppMember.class);
        this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
      }
