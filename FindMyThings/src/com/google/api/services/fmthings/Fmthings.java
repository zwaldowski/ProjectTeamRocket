...
public class Fmthings extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Account {
     ...
     * @return the request
     */
    public CreateAdmin createAdmin(java.lang.String password, java.lang.String passwordAlt, java.lang.String username) throws java.io.IOException {
      CreateAdmin result = new CreateAdmin(password, passwordAlt, username);
      initialize(result);
      return result;
    }
    ...
    public class CreateAdmin extends FmthingsRequest<com.google.api.services.fmthings.model.MessageBean> {
       ...
       * @since 1.13
       */
      protected CreateAdmin(java.lang.String password, java.lang.String passwordAlt, java.lang.String username) {
      ...
      public CreateAdmin setUsername(java.lang.String username) {
     ...
     * @return the request
     */
    public Forgot forgot(java.lang.String username) throws java.io.IOException {
      Forgot result = new Forgot(username);
      initialize(result);
      return result;
    }
    ...
    public class Forgot extends FmthingsRequest<com.google.api.services.fmthings.model.MessageBean> {
       ...
       * @since 1.13
       */
      protected Forgot(java.lang.String username) {
        super(Fmthings.this, "POST", REST_PATH, null, com.google.api.services.fmthings.model.MessageBean.class);
        this.username = com.google.api.client.util.Preconditions.checkNotNull(username, "Required parameter username must be specified.");
      }
      ...
      public Forgot setUsername(java.lang.String username) {
        this.username = username;
        return this;
      }
    ...
    public class Patch extends FmthingsRequest<Void> {
      ...
      protected Patch(com.google.api.services.fmthings.model.AppMember content) {
        super(Fmthings.this, "PATCH", REST_PATH, content, Void.class);
      }
     ...
     * @return the request
     */
    public Register register(java.lang.String password, java.lang.String passwordAlt, java.lang.String username) throws java.io.IOException {
      Register result = new Register(password, passwordAlt, username);
      initialize(result);
      return result;
    }
    ...
    public class Register extends FmthingsRequest<com.google.api.services.fmthings.model.MessageBean> {
       ...
       * @since 1.13
       */
      protected Register(java.lang.String password, java.lang.String passwordAlt, java.lang.String username) {
        super(Fmthings.this, "POST", REST_PATH, null, com.google.api.services.fmthings.model.MessageBean.class);
        this.password = com.google.api.client.util.Preconditions.checkNotNull(password, "Required parameter password must be specified.");
        this.passwordAlt = com.google.api.client.util.Preconditions.checkNotNull(passwordAlt, "Required parameter passwordAlt must be specified.");
        this.username = com.google.api.client.util.Preconditions.checkNotNull(username, "Required parameter username must be specified.");
    ...
    public class Update extends FmthingsRequest<Void> {
      ...
      protected Update(com.google.api.services.fmthings.model.AppMember content) {
        super(Fmthings.this, "PUT", REST_PATH, content, Void.class);
      }
